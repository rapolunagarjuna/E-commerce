...
export default function Products() {
    ...
    return(
        <div className='flex flex-col justify-center items-center'>
            ...
            <div className='w-full pt-36 pb-36 flex flex-col justify-center items center relative' style={{backgroundImage: `url(${bgImg})`, backgroundSize: 'cover', backgroundPosition: 'center', height:"700px" }}>
            ...
            <div className='mt-20  mb-10  text-4xl text-center text-primary'>
